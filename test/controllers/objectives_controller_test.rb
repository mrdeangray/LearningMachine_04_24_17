...
class ObjectivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post objectives_url, params: { objective: { category: @objective.category, completed_at: @objective.completed_at, title: @objective.title, user_id: @objective.user_id } }
    end
  ...
  test "should update objective" do
    patch objective_url(@objective), params: { objective: { category: @objective.category, completed_at: @objective.completed_at, title: @objective.title, user_id: @objective.user_id } }
